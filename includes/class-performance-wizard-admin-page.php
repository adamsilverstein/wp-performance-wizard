...
class Performance_Wizard_Admin_Page {
	...
	public function render_page(): void {
		...
		echo '<div id="performance-wizard-terminal" role="log" aria-live="polite" aria-relevant="additions text" aria-label="' . esc_attr__( 'Performance Wizard conversation', 'wp-performance-wizard' ) . '"></div>';
		echo '</div>';
