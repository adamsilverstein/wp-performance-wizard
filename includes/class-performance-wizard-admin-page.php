...
class Performance_Wizard_Admin_Page {
	...
	public function render_page(): void {
		...
		// Add the description.
		echo '<p>' . __( 'The Performance Wizard will analyze your site using an AI agent, then make recommendations to improve performance.', 'wp-performance-wizard' ) . '</p>';

		// Add a start button.
		echo '<p><button id="performance-wizard-start" class="button button-primary">' . __( 'Start analysis', 'wp-performance-wizard' ) . '</button></p>';
